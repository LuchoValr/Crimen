...
homi12_1=homi12_1.rename(columns={'CANTIDAD':'Homicidios'})
print(homi12_1)
homi12_2=homi12_1.groupby(['DEPARTAMENTO','MUNICIPIO','CODIGO DANE'])['Homicidios'].agg('sum')
print(homi12_2)
...
print(homi13_1)
homi13_1=homi13_1.rename(columns={'CANTIDAD':'Homicidios'})
homi13_2=homi13_1.groupby(['DEPARTAMENTO','MUNICIPIO','CODIGO DANE'])['Homicidios'].agg('sum')
print(homi13_2)
